...
class TreeItem extends Component {
    ...
    render(){
        ...
        return(
            ...
            <div className="tree-item-mobile">
                ...
                <div className="tree-item-mobile-container">
                    <div className="tree-item-top">
                        <p>Their Name:</p>
                        <input autoFocus onChange={(e) => this.props.handleTreeChange(e.target.value, 'rel_name', this.props.tree_rel_id)} value={this.props.rel_name} placeholder={this.props.rel_name || "Name"}/>
                    </div>
                    <div className="tree-item-middle1">
                        ...
                        <div className="tree-item-middle1-bottom">
                            <select onChange={(e) => this.props.handleTreeChange(parseInt(e.target.value, 10), 'rel_bday_mo', this.props.tree_rel_id)} value={this.props.tree[this.props.tree_rel_id_index].rel_bday_mo} name="DOBMonth" disabled={this.state.knowBirth === "dontknow"}>
                                ...
                                <select onChange={(e) => this.props.handleTreeChange(parseInt(e.target.value, 10), 'rel_bday_day', this.props.tree_rel_id)} value={this.props.tree[this.props.tree_rel_id_index].rel_bday_day} name="DOBDAY" disabled={this.state.knowBirth === "dontknow"}>
                    ...
                    <div className="tree-item-bottom">
                        <p>I will give their card:</p>
                            <div>
                                <label className="radio">
                                    <input onChange={(e) => this.props.handleTreeChange(e.target.value, 'rel_delivery', this.props.tree_rel_id)} type="radio" name={`delivery ${this.props.tree_rel_id}`} value="in-person" defaultChecked={this.props.tree[this.props.tree_rel_id_index].rel_delivery === "in-person"}/>
                                    <span>In-Person</span>
                                </label>
                                <label className="radio">
                                    <input onChange={(e) => this.props.handleTreeChange(e.target.value, 'rel_delivery', this.props.tree_rel_id)} type="radio" name={`delivery ${this.props.tree_rel_id}`} value="mail"  defaultChecked={this.props.tree[this.props.tree_rel_id_index].rel_delivery === "mail"}/>
                                    <span>By Mail</span>
                                </label>
                            </div>
                    </div>
            ...
            {/* <div className="tree-item-desktop">
                <h3>{this.props.rel_name}</h3>
                <div className="tree-item-top">
                    <input autoFocus onChange={(e) => this.props.handleTreeChange(e.target.value, 'rel_name', this.props.tree_rel_id)} value={this.props.rel_name} placeholder={this.props.rel_name || "Name"}/>
                    Born On:
                ...
                <div className="tree-item-middle">
                I will give their card:
                    <div>
                        ...
                        By Mail<input onChange={(e) => this.props.handleTreeChange(e.target.value, 'rel_delivery', this.props.tree_rel_id)} type="radio" name={`delivery ${this.props.tree_rel_id}`} value="mail"  defaultChecked={this.props.tree[this.props.tree_rel_id_index].rel_delivery === "mail"}/>
                    </div>
                </div>
                <div className="tree-item-bottom">
                    <select onChange={(e) => this.props.handleTreeChange(e.target.value, 'rel_relationship', this.props.tree_rel_id)} value={this.props.tree[this.props.tree_rel_id_index].rel_relationship}>
